...
// sha256: 3da48dc659af17f5ede4f865bbf5ef168d6d98abf87127ca6b66e934261efc75
use nodes::*;
...
mod __parse__Expressions {
    ...
    impl ExpressionsParser {
        ...
        >(
            &self,
            input: &'input str,
        ) -> Result<Node, __lalrpop_util::ParseError<usize, Token<'input>, &'static str>>
        {
    ...
    ) -> Option<Result<Node,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
    ...
    {
        // Expression = Terminal => ActionFn(3);
        let __sym0 = __pop_Variant1(__symbols);
        let __start = __sym0.0.clone();
        let __end = __sym0.2.clone();
    ...
    {
        // Expressions = Expression, Expressions => ActionFn(1);
    ...
    {
        // Expressions = Expression => ActionFn(2);
        let __sym0 = __pop_Variant1(__symbols);
        let __start = __sym0.0.clone();
        let __end = __sym0.2.clone();
    ...
    {
        // Symbol = r#":[0-9A-Za-z]+"# => ActionFn(10);
        let __sym0 = __pop_Variant0(__symbols);
        let __start = __sym0.0.clone();
        let __end = __sym0.2.clone();
...
mod __intern_token {
    ...
    impl __MatcherBuilder {
        pub fn new() -> __MatcherBuilder {
            ...
            let __regex_vec = vec![
                __regex::Regex::new("^((?u::)(?u:[0-9A-Za-z])+)").unwrap(),
                __regex::Regex::new("^((?u:[-\u{0}-\\)\\+-,0-9;-\\{\\}-\u{10ffff}])*)").unwrap(),
                __regex::Regex::new("^((?u:\\*)(?u:[0-9A-Za-z])+)").unwrap(),
...
>(
    input: &'input str,
    (_, left, _): (usize, Node, usize),
    (_, right, _): (usize, Node, usize),
) -> Node
{
    { trace(Node::Cat(Box::new(left), Box::new(right))) }
}
